...
class DebugLogger:
    ...
    def _truncate_large_fields(self, data: Any, max_length: int = 200) -> Any:
        """fuergrossFeldFortschreitenAusfuehrenAbschneidenUnterbrechenVerarbeiten, BesondersUnterscheidenist base64 KodierenCodeBildAnzahlBasierend auf
        
        Args:
            data: brauchenVerarbeitenAnzahlBasierend auf
            max_length: StringFeldAm meistengrossLangGrad
        
        Returns:
            AbschneidenUnterbrechennachAnzahlBasierend aufKopie
        """
        if isinstance(data, dict):
            result = {}
            for key, value in data.items():
                # fuerBesondersBestimmengrossFeldFortschreitenAusfuehrenAbschneidenUnterbrechen
            ...
            # fuerUeberLangStringFortschreitenAusfuehrenAbschneidenUnterbrechen(kannkannistnichtWissen base64 Feld)
    ...
    def log_response(
        ...
        try:
            ...
            self.logger.info("\n📦 Response Body:")
            if isinstance(body, (dict, list)):
                # fuergrossFeldFortschreitenAusfuehrenAbschneidenUnterbrechenVerarbeiten
