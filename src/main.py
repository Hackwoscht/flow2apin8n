...
async def lifespan(app: FastAPI):
    ...
    if captcha_config.captcha_method == "personal":
        ...
        # StartenResident-Modus: vonErsteStueckVerfuegbartokenAbrufenproject_id
        ...
        if resident_project_id:
            # DirektStartenResident-Modus(wirdAutomatischnavigierenNavigationaufProjektSeite, cookiebereitsPersistentisieren)
            ...
            # KeinhatVerfuegbarproject_idbei, oeffnenAnmeldenFensterBereitstellenBenutzerManuellOperation
    ...
    async def auto_unban_task():
        """Bestimmenbei: jedeStundenPruefenundEntsperren429wurdeDeaktivierentoken"""
        while True:
            try:
                await asyncio.sleep(3600)  # jedeStundenAusfuehreneinMal
...
generation_handler = GenerationHandler(
    ...
    db,
    concurrency_manager,
    proxy_manager  # Hinzufuegen proxy_manager Parameter
)
